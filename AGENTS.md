...
- This repository has no configured formatter, linter, type checker, build backend, or task runner. Do not invent substitute commands.
...
- Before shipping, run the supported free suite and inspect the complete staged diff.
